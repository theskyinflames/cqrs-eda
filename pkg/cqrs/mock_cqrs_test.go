...
// Ensure, that DispatchableMock does implement cqrs.Dispatchable.
// If this is not the case, regenerate this file with moq.
var _ cqrs.Dispatchable = &DispatchableMock{}

// DispatchableMock is a mock implementation of cqrs.Dispatchable.
//
//	func TestSomethingThatUsesDispatchable(t *testing.T) {
//
//		// make and configure a mocked cqrs.Dispatchable
...
//		}
//
//		// use mockedDispatchable in code that requires cqrs.Dispatchable
//		// and then make assertions.
//
//	}
...
//		mockedBus := &BusMock{
//			DispatchFunc: func(contextMoqParam context.Context, dispatchable cqrs.Dispatchable) (interface{}, error) {
...
type BusMock struct {
	...
	calls struct {
		...
		Dispatch []struct {
			...
			Dispatchable cqrs.Dispatchable
		}
	}
...
func (mock *BusMock) Dispatch(contextMoqParam context.Context, dispatchable cqrs.Dispatchable) (interface{}, error) {
	callInfo := struct {
		ContextMoqParam context.Context
		Dispatchable    cqrs.Dispatchable
	}{
