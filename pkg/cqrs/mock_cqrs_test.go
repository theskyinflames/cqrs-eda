...
//			HandleFunc: func(ctx context.Context, cmd cqrs.Command) ([]events.Event, error) {
...
func (mock *CommandHandlerMock) Handle(ctx context.Context, cmd cqrs.Command) ([]events.Event, error) {
	callInfo := struct {
		Ctx context.Context
		Cmd cqrs.Command
	}{
